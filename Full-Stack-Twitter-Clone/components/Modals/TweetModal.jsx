        ...
        <div className='relative w-full h-full md:w-[600px] md:h-[40%] dark:bg-black bg-white rounded-xl md:fixed md:top-20 pb-4'>
          <div className='top_section flex px-4 h-[53px] w-full justify-between items-center grow '>
            ...
            <div className=' flex justify-end '>
              <button
               className={`bg-twitter-blue md:hidden text-white rounded-full px-4 py-2 text-sm font-semibold ${ disabled ? 'opacity-50 cursor-not-allowed' : 'hover:opacity-70'}`}
          ...
          <div className='w-full mx-auto flex flex-col gap-10'>
            <div className=' max-w-[600px] w-full px-8 m-auto'>
              ...
              <div className='flex flex-row justify-between items-center h-12'>
                ...
                <div className=' '>
              <button
                className={`bg-twitter-blue ms:hidden md:block text-white rounded-full px-4 py-2 text-sm font-semibold ${ disabled ? 'opacity-50 cursor-not-allowed' : 'hover:opacity-80'}`}
                onClick={submitHandler}
                disabled={disabled}
              >
                Post
